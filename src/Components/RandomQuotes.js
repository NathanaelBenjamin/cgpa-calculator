...
const RandomQuotes = () => {
    ...
    return (
        <div className='quotes flex-center bg-blue-400 py-20 md:py-20 px-2 md:px-8'>
            <div className="h-64 flex-center justify-between md:justify-start gap-9 text-center">
