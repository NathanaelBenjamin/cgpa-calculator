    ...
    return (
        <div className='quotes flex-center bg-blue-400 pt-12 pb-16 md:py-20 px-2 md:px-8'>
            <div className="h-64 flex-center justify-start gap-9 text-center">
                <blockquote className="text-white text-4xl italic">{quote ? `"${quote.content}"` : "\"Learning is not attained by chance; it must be sought for with ardor and attended to with diligence\""}</blockquote>
